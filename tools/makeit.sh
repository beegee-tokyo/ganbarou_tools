...
if [ $DO_P750T -eq 0 ]; then
  res75001=$(date +%s.%N)
   ...
   echo -e $CL_MAG"=============================================="$CL_RST
   export TARGET_KERNEL_CUSTOM_TOOLCHAIN=arm-eabi-4.6
...
if [ $DO_N7000 -eq 0 ]; then
   ...
   if [ $? -eq 0 ]; then
      ...
      ./patchit.sh GT-N7000 GT-N7000 0 n7000 cm 0
   else
      echo -e $CL_MAG"=============================================="$CL_RST
...
if [ $DO_I9505 -eq 0 ]; then
   echo -e $CL_MAG"=============================================="$CL_RST
   echo -e $CL_MAG"Start the build for GT-I9505"$CL_RST
   echo -e $CL_MAG"=============================================="$CL_RST
   res95051=$(date +%s.%N)
   ...
   if [ $? -eq 0 ]; then
      ...
      echo -e $CL_MAG"=============================================="$CL_RST
      export I9505RESULT=0
      ./patchit.sh GT-I9505 GT-I9505 0 jfltexx cm 0
   else
      echo -e $CL_MAG"=============================================="$CL_RST
